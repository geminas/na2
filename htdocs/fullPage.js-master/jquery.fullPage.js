    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function styleSection(section, index){
            ...
            //section.css('height', windowsHeight + 'px'); //Donhai

            if(options.paddingTop){
                if(index===0) section.css('padding-top', options.paddingTop); //Donghia
                else section.css('margin-top', options.paddingTop); //Donghai
            }
