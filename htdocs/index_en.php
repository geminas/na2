                ...
                <div class="tp-banner-container" style="margin-top:0; margin-bottom:0">
                    <div class="tp-banner-boxed">
                        <ul>
                            ...
                            ?>
                            <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="<?php echo $slide['bigtitle_en'];?>">
                                <!-- MAIN IMAGE -->
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="gdhbutton buttonblack">
                        <a href="people_en.php"><?php echo findmisc('homepage-people-button');?></a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="gdhbutton buttonblack" style="margin:0;">
                            <a href="footprints_en.php"><?php echo findmisc('homepage-footprint-button');?></a>
                        </div>
                    </div>
                </div>
